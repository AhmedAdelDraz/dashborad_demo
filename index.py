...
app.layout = html.Div([
    ...
    html.Div([
        dbc.Row([
            dbc.Col(
                dbc.Button("Video Games", outline=True, color="primary", href='/apps/vgames', className="sm"),
                    width={'size':2,'offset':0}),
            dbc.Col(
                dbc.Button("Other Products", outline=True, color="primary", href='/apps/global_sales', className="sm"),
                    width={'size':2,'offset':0})
            ]),
    ], className="row"),
    html.Div(id='page-content', children=[])
